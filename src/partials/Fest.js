    ...
    return(
      <div className="infoContainer">
        ...
        <div className="textWrapper">
          <h1>OSA formulär</h1>
          <i className="noStyle">Här anger du om du planerar att komma på vigseln och festen eller inte. <br />Notera att du behöver ange varje person i ditt sällskap för sig.</i>
          <OSAForm />
        </div>
        { children }
      </div>
...
function OSAForm() {
  ...
  const submitAccept = () => {
    ...
    }).catch(err => { alert("Hoppsan, det gick inte att skicka in dina uppgifter. Försök igen!"); console.log(err) });
  }
